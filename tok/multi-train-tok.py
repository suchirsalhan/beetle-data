...
Security Note: 
`trust_remote_code` has been removed entirely. FineWeb-2 and 
FineWeb-edu are verified Parquet datasets and load natively.
"""
...
LANG_CONFIGS: dict = {
    "pl": {
        ...
        "test_cases": {"PL_Simple": "Cześć, jak się masz?", "PL_Diacritics": "Żółw skacze przez źródło w środę."}
    },
    "nl": {
        "name": "Dutch", "fw2_name": "nld_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"NL_Simple": "Hallo, hoe gaat het?", "NL_Compound": "De regeringsverantwoordelijkheid is groot."}
    },
    "es": {
        "name": "Spanish", "fw2_name": "spa_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"ES_Simple": "Hola, ¿cómo estás?", "ES_Accents": "El niño está jugando."}
    },
    "fr": {
        "name": "French", "fw2_name": "fra_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"FR_Simple": "Bonjour, comment allez-vous?", "FR_Accents": "L'été, nous préférons les crêpes."}
    },
    "de": {
        "name": "German", "fw2_name": "deu_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"DE_Simple": "Hallo, wie geht es Ihnen?", "DE_Compound": "Donaudampfschifffahrt."}
    },
    "it": {
        "name": "Italian", "fw2_name": "ita_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"IT_Simple": "Ciao, come stai?", "IT_Accents": "Però, è già tardi."}
    },
    "sv": {
        "name": "Swedish", "fw2_name": "swe_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"SV_Simple": "Hej, hur mår du?", "SV_Umlauts": "Åsa och Björn åker till Göteborg."}
    },
    "ca": {
        "name": "Catalan", "fw2_name": "cat_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"CA_Simple": "Hola, com estàs?", "CA_Accents": "El col·legi és a l'avinguda."}
    },
    "eu": {
        "name": "Basque", "fw2_name": "eus_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 1,
        "test_cases": {"EU_Simple": "Kaixo, nola zaude?", "EU_Agglutinative": "Etxekoandrearekin."}
    },
    "tr": {
        "name": "Turkish", "fw2_name": "tur_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"TR_Simple": "Merhaba, nasılsınız?", "TR_Agglutinative": "Çekoslovakyalılaştıramadıklarımızdanmışsınız."}
    },
    "id": {
        "name": "Indonesian", "fw2_name": "ind_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"ID_Simple": "Halo, apa kabar?", "ID_Morphology": "Mempertanggungjawabkan."}
    },
    "tl": {
        "name": "Tagalog", "fw2_name": "tgl_Latn", "script": "Latin", "model": "bpe", "normalizer": "nfkc", "min_freq": 1,
        "test_cases": {"TL_Simple": "Kamusta ka?", "TL_Affixes": "Pinaghandaan namin."}
    },
    "el": {
        "name": "Greek", "fw2_name": "ell_Grek", "script": "Greek", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"EL_Simple": "Γεια σου, πώς είσαι;", "EL_Polytonic": "Ἐν ἀρχῇ ἦν ὁ λόγος."}
    },
    "ru": {
        "name": "Russian", "fw2_name": "rus_Cyrl", "script": "Cyrillic", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"RU_Simple": "Привет, как дела?", "RU_Morphology": "Непротивостоянию."}
    },
    "zh": {
        "name": "Chinese", "fw2_name": "cmn_Hani", "script": "Han", "model": "bpe", "normalizer": "nfc", "add_prefix_space": True, "trim_offsets": True, "clean_up_spaces": True, "min_freq": 2,
        "test_cases": {"ZH_Simple": "你好，我饿了。", "ZH_Long": "人工智能技术正在改变我们的生活方式。"}
    },
    "ar": {
        "name": "Arabic", "fw2_name": "arb_Arab", "script": "Arabic", "model": "unigram", "normalizer": "nfkc+tatweel", "clean_up_spaces": False, "shrinking_factor": 0.75, "max_piece_length": 20, "n_sub_iterations": 2,
        "test_cases": {"AR_Simple": "مرحباً، أنا جائع.", "AR_Clitics": "وسيكتبونها في التقرير."}
    },
    "fa": {
        "name": "Persian", "fw2_name": "pes_Arab", "script": "Arabic", "model": "bpe", "normalizer": "nfkc+tatweel", "min_freq": 2,
        "test_cases": {"FA_Simple": "سلام، حال شما چطور است؟", "FA_ZWNJ": "می‌روم به مدرسه."}
    },
    "hi": {
        "name": "Hindi", "fw2_name": "hin_Deva", "script": "Devanagari", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"HI_Simple": "नमस्ते, आप कैसे हैं?", "HI_Compound": "विश्वविद्यालय में प्रवेश परीक्षा।"}
    },
    "ta": {
        "name": "Tamil", "fw2_name": "tam_Taml", "script": "Tamil", "model": "bpe", "normalizer": "nfkc", "min_freq": 2,
        "test_cases": {"TA_Simple": "வணக்கம், நீங்கள் எப்படி இருக்கிறீர்கள்?", "TA_Compound": "தமிழ்நாட்டில் பல கோயில்கள் உள்ளன."}
    },
}
...
def get_training_corpus(cfg, n_sentences):
    # trust_remote_code removed for datasets v4.0 compatibility
...
def main():
    ...
    print(f"🚀 Training {args.lang.upper()} tokenizer...")
