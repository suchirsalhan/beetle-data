#beetle-data/data/decontaminate.py

"""
Instructions from https://github.com/EleutherAI/lm-evaluation-harness/blob/main/docs/decontamination.md

Build dictionaries of all ngrams and their corresponding evaluation/document ids.
Scan through sorted files containing training set n-grams.
If a match is found, the corresponding evaluation/document combinations are marked as contaminated.
...
This is disabled by default for new tasks, to support decontamination on a task override the "should_decontaminate" and "doc_to_decontamination_query" methods. For more details see the task guide.


Code based on https://github.com/EleutherAI/lm-evaluation-harness/blob/main/lm_eval/decontamination/decontaminate.py
"""
